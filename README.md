...
The device was running an  Tolino firmware 112358132fb on Android 4.4.2, so I used the Tolino debug menu code for that firmware generation to enable debug mode from the search field.
